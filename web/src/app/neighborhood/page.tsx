...
export default function NeighborhoodPage() {
  ...
  return (
    ...
    >
      {variant && (
        <header className="z-40 shrink-0 border-b border-zinc-800 bg-zinc-950/95 px-4 py-3 backdrop-blur-sm">
      ...
      <div className="min-h-0 flex-1">
        {!variant ? (
          <HouseColorPicker onChoose={handleChoose} />
        ) : (
          <IsoWorldMap playerVariantId={variant} />
        )}
      </div>
    </div>
  );
